...
export const menuData: Category[] = [
  ...
  },
  {
    ...
    name: 'Batatas',
    items: [
      { id: 'batata-1', name: 'Meia Batata', price: 15, image: '/MeiaBatata.png' },
      { id: 'batata-2', name: 'Batata Frita', price: 25, image: '/BatataFrita.png' },
      { id: 'batata-3', name: 'Meia Batata c/ Bacon', price: 20, image: '/MeiaBatatacBacon.png' },
      { id: 'batata-4', name: 'Meia Batata c/ Linguiça', price: 20, image: '/MeiaBatatacLinguica.png' },
      { id: 'batata-5', name: 'Meia Batata, Cheddar e Linguiça', price: 20, image: '/MeiaBatataCheddareLinguica.png' },
      { id: 'batata-6', name: 'Batata Frita c/ Bacon', price: 30, image: '/BatataFritacBacon.png' },
      { id: 'batata-7', name: 'Batata Frita c/ Linguiça', price: 35, image: '/BatataFritacLinguica.png' },
      { id: 'batata-8', name: 'Batata Frita c/ Cheddar', price: 40, image: '/BatataFritacCheddar.png' },
    ],
  },
  {
    id: 'pratos',
